...
public class CsrAttribute implements Serializable {
    ...
    public static final String ATTRIBUTE_CSR_DECISION_NOTIFICATION = "CSR_DECISION_NOTIFICATION";
    public static final String ATTRIBUTE_CSR_DECISION_NOTIFICATION_COUNTER = "CSR_DECISION_NOTIFICATION_COUNTER";
