...
public class AuditService {
    ...
    public static final String AUDIT_EST_CERTIFICATE_REQUESTED = "EST_CERTIFICATE_REQUESTED";
    ...
    public static final String AUDIT_CERTIFICATE_SET_NOTIFICATION_BLOCKED = "CERTIFICATE_SET_NOTIFICATION_BLOCKED";
    public static final String AUDIT_CERTIFICATE_UNSET_NOTIFICATION_BLOCKED = "CERTIFICATE_UNSET_NOTIFICATION_BLOCKED";
    ...
    public static final String AUDIT_FILL_EMPTY_DATABASE_CHANGED = "AUDIT_FILL_EMPTY_DATABASE_CHANGED";
    public static final String AUDIT_FILL_EMPTY_CERTIFICATE_COLUMN_CHANGED = "AUDIT_FILL_EMPTY_CERTIFICATE_COLUMN_CHANGED";
    public static final String AUDIT_FILL_EMPTY_SEQUENCE_COLUMN_CHANGED = "AUDIT_FILL_EMPTY_SEQUENCE_COLUMN_CHANGED";
    public static final String AUDIT_FILL_EMPTY_LAST_UPDATE_COLUMN_CHANGED = "AUDIT_FILL_EMPTY_LAST_UPDATE_COLUMN_CHANGED";
    public static final String AUDIT_IS_DATABASE_CHANGED = "AUDIT_IS_DATABASE_CHANGED";
    public static final String AUDIT_CERTIFICATE_COLUMN_CHANGED = "AUDIT_CERTIFICATE_COLUMN_CHANGED";
    public static final String AUDIT_CERTIFICATE_TABLE_CHANGED = "AUDIT_CERTIFICATE_TABLE_CHANGED";
    public static final String AUDIT_SEQUENCE_COLUMN_CHANGED = "AUDIT_SEQUENCE_COLUMN_CHANGED";
    public static final String AUDIT_LAST_UPDATE_COLUMN_CHANGED = "AUDIT_LAST_UPDATE_COLUMN_CHANGED";
    public static final String AUDIT_FILL_EMPTY_CERTIFICATE_TABLE_CHANGED = "AUDIT_FILL_EMPTY_CERTIFICATE_TABLE_CHANGED";
