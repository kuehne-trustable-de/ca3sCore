...
,
    ...
    },
    {
      ...
      name: 'UserPreferenceCreate',
      component: UserPreferenceUpdate,
      meta: { authorities: [Authority.USER] }
    },
    {
      path: '/user-preference/:userPreferenceId/edit',
      name: 'UserPreferenceEdit',
      component: UserPreferenceUpdate,
      meta: { authorities: [Authority.USER] }
    },
    {
      path: '/user-preference/:userPreferenceId/view',
      name: 'UserPreferenceView',
      component: UserPreferenceDetails,
      meta: { authorities: [Authority.USER] }
    }
