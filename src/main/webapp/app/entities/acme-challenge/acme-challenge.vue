    ...
    <div>
        ...
        <div class="table-responsive" v-if="acmeChallenges && acmeChallenges.length > 0">
            <table class="table table-striped">
                ...
                <tr v-for="acmeChallenge in acmeChallenges"
                    ...
                    <td>{{acmeChallenge.validated ? $d(Date.parse(acmeChallenge.validated), 'short') : ''}}</td>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-acmeChallenge-heading" v-text="$t('ca3SApp.acmeChallenge.delete.question', {'id': removeId})">Are you sure you want to delete this Acme Challenge?</p>
            </div>
