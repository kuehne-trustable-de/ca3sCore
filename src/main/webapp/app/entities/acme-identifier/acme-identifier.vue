    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-acmeIdentifier-heading" v-text="$t('ca3SApp.acmeIdentifier.delete.question', {'id': removeId})">Are you sure you want to delete this Acme Identifier?</p>
            </div>
