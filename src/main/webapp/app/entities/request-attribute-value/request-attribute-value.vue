    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-requestAttributeValue-heading" v-text="$t('ca3SApp.requestAttributeValue.delete.question', {'id': removeId})">Are you sure you want to delete this Request Attribute Value?</p>
            </div>
