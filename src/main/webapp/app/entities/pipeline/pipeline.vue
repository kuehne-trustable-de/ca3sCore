    ...
    <div>
                ...
                <tr v-for="pipeline in pipelines"
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            ...
                            <router-link :to="{name: 'PipelineEdit', params: {pipelineId: pipeline.id}}"  tag="button" class="btn btn-primary btn-sm edit">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-pipeline-heading" v-bind:title="$t('ca3SApp.pipeline.delete.question')">Are you sure you want to delete this Pipeline?</p>
            </div>
