        ...
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('ca3SApp.cAConnectorConfig.plainSecret')" for="ca-connector-config-plainSecret">Plain Secret</label>
                        <input type="text" class="form-control" name="plainSecret" id="ca-connector-config-plainSecret"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="ca-connector-config-secret" name="secret" v-model="cAConnectorConfig.secret">
                            <option v-bind:value="null"></option>
                            <option v-bind:value="cAConnectorConfig.secret && protectedContentOption.id === cAConnectorConfig.secret.id ? cAConnectorConfig.secret : protectedContentOption" v-for="protectedContentOption in secrets" :key="protectedContentOption.id">{{protectedContentOption.id}}</option>
                        </select>
                    </div>
                </div>
                <div>
