<template>
    <div>
        <h2 id="page-heading">
            ...
            <router-link :to="{name: 'CAConnectorConfigCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-ca-connector-config">
        ...
        <div class="table-responsive" v-if="cAConnectorConfigs && cAConnectorConfigs.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('ca3SApp.cAConnectorConfig.plainSecret')">Plain Secret</span></th>
                ...
                <tr v-for="cAConnectorConfig in cAConnectorConfigs"
                    ...
                    <td>{{cAConnectorConfig.plainSecret}}</td>
                    <td>
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            ...
                            <router-link :to="{name: 'CAConnectorConfigEdit', params: {cAConnectorConfigId: cAConnectorConfig.id}}"  tag="button" class="btn btn-primary btn-sm edit">
