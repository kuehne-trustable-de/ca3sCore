    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-acmeAuthorization-heading" v-text="$t('ca3SApp.acmeAuthorization.delete.question', {'id': removeId})">Are you sure you want to delete this Acme Authorization?</p>
            </div>
