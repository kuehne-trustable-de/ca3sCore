                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.identifier.identifierId.$anyDirty && $v.identifier.identifierId.$invalid">
                            ...
                            <small class="form-text text-danger" v-if="!$v.identifier.identifierId.number" v-text="$t('entity.validation.number')">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('ca3SApp.identifier.order')" for="identifier-order">Order</label>
