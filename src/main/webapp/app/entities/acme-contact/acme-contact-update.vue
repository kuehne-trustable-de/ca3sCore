                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.acmeContact.contactId.$anyDirty && $v.acmeContact.contactId.$invalid">
                            ...
                            <small class="form-text text-danger" v-if="!$v.acmeContact.contactId.number" v-text="$t('entity.validation.number')">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('ca3SApp.acmeContact.account')" for="acme-contact-account">Account</label>
