    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-requestProxyConfig-heading" v-text="$t('ca3SApp.requestProxyConfig.delete.question', {'id': removeId})">Are you sure you want to delete this Request Proxy Config?</p>
            </div>
