    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-pipelineAttribute-heading" v-text="$t('ca3SApp.pipelineAttribute.delete.question', {'id': removeId})">Are you sure you want to delete this Pipeline Attribute?</p>
            </div>
