    ...
    <div>
        ...
        <div class="table-responsive" v-if="acmeNonces && acmeNonces.length > 0">
            <table class="table table-striped">
                ...
                <tr v-for="acmeNonce in acmeNonces"
                    ...
                    <td>{{acmeNonce.expiresAt ? $d(Date.parse(acmeNonce.expiresAt), 'short') : ''}}</td>
                    <td class="text-right">
                        <div class="btn-group">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-acmeNonce-heading" v-text="$t('ca3SApp.acmeNonce.delete.question', {'id': removeId})">Are you sure you want to delete this Acme Nonce?</p>
            </div>
