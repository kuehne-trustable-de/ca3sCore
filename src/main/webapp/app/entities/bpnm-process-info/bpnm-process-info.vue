    ...
    <div>
        ...
        <div class="table-responsive" v-if="bPNMProcessInfos && bPNMProcessInfos.length > 0">
            <table class="table table-striped">
                ...
                <tr v-for="bPNMProcessInfo in bPNMProcessInfos"
                    ...
                    <td>{{bPNMProcessInfo.lastChange ? $d(Date.parse(bPNMProcessInfo.lastChange), 'short') : ''}}</td>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-bPNMProcessInfo-heading" v-text="$t('ca3SApp.bPNMProcessInfo.delete.question', {'id': removeId})">Are you sure you want to delete this BPNM Process Info?</p>
            </div>
