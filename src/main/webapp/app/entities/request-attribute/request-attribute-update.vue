        ...
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('ca3SApp.requestAttribute.holdingRequestAttribute')" for="request-attribute-holdingRequestAttribute">Holding Request Attribute</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('ca3SApp.requestAttribute.csr')" for="request-attribute-csr">Csr</label>
