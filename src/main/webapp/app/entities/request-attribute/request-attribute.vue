    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-requestAttribute-heading" v-text="$t('ca3SApp.requestAttribute.delete.question', {'id': removeId})">Are you sure you want to delete this Request Attribute?</p>
            </div>
