    ...
    <div>
        ...
        <div class="table-responsive" v-if="importedURLS && importedURLS.length > 0">
            <table class="table table-striped">
                ...
                <tr v-for="importedURL in importedURLS"
                    ...
                    <td>{{importedURL.importDate ? $d(Date.parse(importedURL.importDate), 'short') : ''}}</td>
                    <td class="text-right">
                        <div class="btn-group">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-importedURL-heading" v-text="$t('ca3SApp.importedURL.delete.question', {'id': removeId})">Are you sure you want to delete this Imported URL?</p>
            </div>
