    ...
    <div class="modal-body">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <b-alert show variant="info" v-if="loginMode === 'spnego' && spnegoAuthenticationError === false" v-html="$t('login.messages.info.spnegoLogin')"></b-alert>

            </div>

            <div class="col-md-8">
                <div v-if="loginMode === 'spnego'">
