    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate >
				...
				<h2 class="jh-entity-heading"><span v-text="$t('ca3SApp.upload.detail.title')">Upload</span></h2>
				<div >

                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('ca3SApp.upload.content')" for="upload-content">Content</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('ca3SApp.upload.passphrase')" for="upload-passphrase">Passphrase</label>
					...
					<dl class="row jh-entity-details" v-if="isChecked === true && precheckResponse.dataType === 'CSR'">
						...
						<div v-if="precheckResponse.publicKeyPresentInDB === true">
							<dt>
								<span v-text="$t('ca3SApp.upload.warning')">Warning</span>
							</dt>
							<dd>
								<span v-text="$t('ca3SApp.upload.warning.publicKeyPresent')">Public key already in use</span>
							</dd>
						</div>

						<dt>
							<span v-text="$t('ca3SApp.upload.subject')">Subject</span>
						</dt>
						<dd>
						...
						<dt>
							<span v-text="$t('ca3SApp.upload.algoname')">Build with</span>
						</dt>
						<dd>
					...
					<dl class="row jh-entity-details" v-if="isChecked === true && precheckResponse.dataType === 'X509_CERTIFICATE'">
						...
						<dd>
								<span v-text="$t('ca3SApp.upload.certificate')">X.509 certificate</span>
						</dd>
						...
						<dt>
							<span v-text="$t('ca3SApp.upload.issuer')">Issuer</span>
						</dt>
						<dd>
						...
						<dt>
							<span v-text="$t('ca3SApp.upload.certificate.validfrom')">Valid from</span>
						</dt>
						<dd>
						...
						<dt>
							<span v-text="$t('ca3SApp.upload.certificate.validto')">Valid to</span>
						</dt>
						<dd>
                ...
                <div v-if="authenticated">
                    <button type="button" id="uploadContent"  class="btn btn-primary" v-on:click="uploadContent">
                        <font-awesome-icon icon="save"></font-awesome-icon>&nbsp;<span v-text="$t('ca3SApp.upload.upload')">Upload</span>
                    </button>
                </div>
