    ...
    <b-navbar toggleable="md" type="light" class="jh-navbar" >
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand logged_in="true" class="logo float-left" b-link to="/" v-if="authenticated">
                <span v-if="username && hasTenant()" v-text="$t('home.logged.tenant.message', { 'username': username, 'roles': roles, 'tenant':tenant})" class="navbar-version"></span>
                <span v-if="username && !hasTenant()" v-text="$t('home.logged.message', { 'username': username, 'roles': roles})" class="navbar-version"></span>
            </b-navbar-brand>
        </div>
