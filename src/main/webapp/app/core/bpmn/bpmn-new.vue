    ...
    <div class="row justify-content-center">
        <div class="col-8">
            ...
            <div class="form-group" v-if="bpmnFileUploaded">
                ...
                <label class="form-control-label" v-text="$t('ca3SApp.bPNMProcessInfo.new.version')" >Version</label> <help-tag role="Admin" target="bpmn.version"/>
                ...
                <small class="form-text text-danger" v-if="showSemVerRegExpFieldWarning(bpmnUpload.version)" v-text="$t('ca3SApp.messages.semver.requirement')">
