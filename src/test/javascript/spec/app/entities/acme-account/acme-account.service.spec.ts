...
describe('Service Tests', () => {
  describe('ACMEAccount Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a ACMEAccount', async () => {
      ...
      it('should not update a ACMEAccount', async () => {
      ...
      it('should not return a list of ACMEAccount', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a ACMEAccount', async () => {
