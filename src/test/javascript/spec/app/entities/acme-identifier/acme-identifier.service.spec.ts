...
describe('Service Tests', () => {
  describe('AcmeIdentifier Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a AcmeIdentifier', async () => {
      ...
      it('should not update a AcmeIdentifier', async () => {
      ...
      it('should not return a list of AcmeIdentifier', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a AcmeIdentifier', async () => {
