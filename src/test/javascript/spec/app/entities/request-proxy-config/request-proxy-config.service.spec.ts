...
describe('Service Tests', () => {
  describe('RequestProxyConfig Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a RequestProxyConfig', async () => {
      ...
      it('should not update a RequestProxyConfig', async () => {
      ...
      it('should not return a list of RequestProxyConfig', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a RequestProxyConfig', async () => {
