...
describe('Service Tests', () => {
  describe('RequestAttributeValue Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a RequestAttributeValue', async () => {
      ...
      it('should not update a RequestAttributeValue', async () => {
      ...
      it('should not return a list of RequestAttributeValue', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a RequestAttributeValue', async () => {
