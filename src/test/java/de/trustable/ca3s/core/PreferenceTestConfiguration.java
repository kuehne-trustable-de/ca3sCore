...
public class PreferenceTestConfiguration {
    ...
    public Preferences getTestUserPreference(final int primaryPort) {
        ...
        initTestUserPreference(PreferenceUtil.SELECTED_SIGNING_ALGOS, "rsa-2048,rsa-3072,rsa-4096,rsa-6144,rsa-8192,ecdsa-256, ecdsa-512,Ed25519,brainpoolP256r1", SYSTEM_PREFERENCE_ID);
