...
public class ScreenRecorderUtil extends ScreenRecorder {
    ...
    public ScreenRecorderUtil(GraphicsConfiguration cfg,
 ...
 //       screenRecorder.setAudioMixer(getMixer());
    ...
    static Mixer getMixer(){
        ...
        for (Mixer.Info info: mixerInfos){
            ...
            for (Line.Info lineInfo:lineInfos){
                ...
                try {
                    if( AudioSystem.getLine(lineInfo) instanceof SourceDataLine ) {
                        System.out.println("source line level: " + ((SourceDataLine) AudioSystem.getLine(lineInfo)).getLevel());
                    }
...
//                System.out.println ("target line info: "+lineInfo);
            ...
            if( "Primärer Soundaufnahmetreiber".equalsIgnoreCase(info.getName())){
                return m;
            }
