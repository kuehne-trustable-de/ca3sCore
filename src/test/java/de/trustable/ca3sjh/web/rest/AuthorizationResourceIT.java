...
import de.trustable.ca3sjh.service.AuthorizationService;
...
public class AuthorizationResourceIT {
    ...
    public void setup() {
        ...
        final AuthorizationResource authorizationResource = new AuthorizationResource(authorizationService);
