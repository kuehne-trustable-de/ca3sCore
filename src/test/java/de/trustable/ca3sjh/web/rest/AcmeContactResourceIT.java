...
import de.trustable.ca3sjh.service.AcmeContactService;
...
public class AcmeContactResourceIT {
    ...
    public void setup() {
        ...
        final AcmeContactResource acmeContactResource = new AcmeContactResource(acmeContactService);
        this.restAcmeContactMockMvc = MockMvcBuilders.standaloneSetup(acmeContactResource)
